            ...
            <div class="flex items-center justify-between">
                <div class="max-w-lg w-full lg:max-w-xs">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.debounce.350mx="search" id="search"
                        ...
                        <tr>
                            <th
                                ...
                                <div class="flex-items-center">
                                    <button wire:click="sortBy('name')" class="bg-gray-50 font-medium text-xs leading-4 uppercase tracking-wider">ICON</button>
                                </div>
                            </th>
                            <th
                                class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                Email
                                <div class="flex-items-center">
                                    <button wire:click="sortBy('email')" class="bg-gray-50 font-medium text-xs leading-4 uppercase tracking-wider">ICON</button>
                                </div>
                            </th>
                            <th
                                class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
